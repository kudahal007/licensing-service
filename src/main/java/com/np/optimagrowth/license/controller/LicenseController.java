package com.np.optimagrowth.license.controller;

import com.np.optimagrowth.license.model.License;
import com.np.optimagrowth.license.service.LicenseService;
...
public class LicenseController {
    ...
    public ResponseEntity<License> getLicense(@PathVariable("organizationId") String organizationId,
        ...
        license.add(linkTo(methodOn(LicenseController.class)
                ...
                linkTo(methodOn(LicenseController.class)
                        .updateLicense(license,null)).withRel("updateLicense"),
                linkTo(methodOn(LicenseController.class)
                        .deleteLicense(license.getLicenseId())).withRel("deleteLicense"));
    ...
    public ResponseEntity<String> createLicense(@PathVariable("organizationId") String organizationId,
        ...
        return ResponseEntity.ok(licenseService.createLicense(organizationId,request,locale));
    }
